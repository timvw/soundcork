...
| Home Assistant | Working | Media player entities, Lovelace card — [soundcork-hass](https://github.com/timvw/soundcork-hass) |
...
Control your speakers from Home Assistant with the [soundcork-hass](https://github.com/timvw/soundcork-hass) integration. Install via [HACS](https://hacs.xyz/) as a custom repository.
...
See [Home Assistant docs](docs/home-assistant.md) for setup and API reference.
